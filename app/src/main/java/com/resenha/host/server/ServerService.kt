...
import com.resenha.host.MainActivity
import com.resenha.host.R
...
class ServerService : Service() {
    ...
    override fun onCreate() {
        ...
        scope.launch {
            server.activeGame.collect { ServerState.activeGame.value = it }
        }
        scope.launch {
            server.codenamesMode.collect { ServerState.codenamesMode.value = it }
        }
        scope.launch {
            server.sintoniaMode.collect { ServerState.sintoniaMode.value = it }
        }
    }
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "resenha_server"
    }
}
